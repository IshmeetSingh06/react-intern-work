    ...
    <div className="term-container">
      ...
      <ul className="terms-lists">
        <li className="term-list-item">
          ...
          of the TakTik app (including but not limited to TakTik app’s Privacy
          Policy, which is hereby incorporated by reference). The Terms take
          effect upon you using the TakTik app. If you wish to opt-out of the
          Terms, you will have to discontinue using the services of the TakTik
        ...
        <li className="term-list-item">
          ...
          Through the TakTik app a User, exercising knowledge about a given
          subject and based on publicly available information (including such
          information collated and made available through the TakTik app
        ...
        <li className="term-list-item">
          ...
          TakTik app constitutes the User’s acceptance of such Terms and
          Conditions, rules, regulations and terms of use referred to herein or
          provided by TakTik app in relation to any TakTik app Services, as may
          be amended from time to time. We reserve the right to modify the
          Terms, at any time of our choosing. We will notify you when material
          changes have been made to the Terms. The factum of whether the change
          is material or not is left to the discretion of the Company. You will
          therefore be responsible for checking the Terms on a regular basis to
          understand whether the same have been updated. Your continued use of
      ...
      <ul>
        ...
        <li className="term-list-item">
          ...
          any content generated by you on the platform, including but not
          limited to, any messages sent via the platform.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li className="term-list-item">
          ...
          occurrence and outcome of the specified future event. The User’s bid
          will be considered as successful if the parameters which formed the
          user’s bid are met or have occurred. Vice versa, if the parameters
        ...
        <li className="term-list-item">
          ...
          Although TakTik app provides the related data and information for the
          specified events, the users are encouraged to collect their own data
          and conduct thorough analysis related to the specific event before
          taking any positions/bids. User’s should take positions once they have
      ...
      <ul>
        <li className="term-list-item">
          ...
          app may, at its sole and absolute discretion, take necessary remedial
        ...
        <ul>
          ...
          <li className="term-list-item">
            ...
            deletion shall be transferred to the User’s bank account on record
            with TakTik app subject to a processing fee (if any) applicable on
        ...
        <li className="term-list-item">
          ...
          passwords. Users agree to immediately notify TakTik app of any
        ...
        <li className="term-list-item">
          ...
          time of getting access to the TakTik app Platform. If a person
          declares a false age, TakTik app shall not be held responsible and
          such person shall, in addition to forfeiting any and all rights over
          their TakTik app Account, shall indemnify and hold TakTik app, its
          Directors, officers, employees, agents, affiliates harmless of any and
          all losses that may be suffered by TakTik app its Directors, officers,
          ...
          the age of 18 such person’s legal guardians shall indemnify and hold
          TakTik app, its Directors, officers, employees, agents, affiliates
          harmless of any and all losses that may be suffered by TakTik app its
        ...
        <li className="term-list-item">
          ...
          not limited to your mobile device), software, data or other property
          as a result of your download, installation, access to or use of TakTik
          app or your obtaining any material from, or as a result of using, the
      ...
      <ul>
        ...
        <li className="term-list-item">
          ...
          payment gateway services. You will be required to independently review
          the terms and conditions and privacy policy governing the third party
        ...
        <li className="term-list-item">
          ...
          provider and covenant that that card/internet banking details do
          belong to you. The information provided by you will not be utilized or
          shared with any third party unless required in relation to fraud
      ...
      <ul>
        <li className="term-list-item">
          ...
          intellectual property, on TikTak Opinions, and in the material
